...
In order to keep our project up-to-date with dependencies we use a tool called ([الربح من السناب شات](https://www.shrh.org/2022/12/how-to-make-money-from-snapchat-and-the-spotlight-platform.html)). If you’re not interested in this tooling, delete the `renovate.json` file and commit that onto your main branch.
